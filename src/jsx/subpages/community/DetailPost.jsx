            ...
            <div className="detail_post_wrap">
                ...
                <div className="write_reply_box">
                    <div className="each_reply_box">
                        ...
                        <div className="reply_text_content">댓글 1 댓글 1 댓글 1 댓글 1 댓글 1 댓글 1 댓글 1</div>
                    </div>
                    <div className="each_reply_box">
                        <div className="flex_for_profile">
                            <div className="flex">
                        ...
                        <div className="reply_text_content">
                            댓글 2 댓글 2 댓글 2 댓글 2 댓글 2 댓글 2 댓글 2 댓글 2 댓글 2 댓글 2 댓글 2 댓글 2 댓글 2
                            댓글 2 댓글 2
                        </div>
                        <div className="each_re_reply_text_content">
                            ...
                            <div className="re_reply_content_box">
                                ...
                                <div className="reply_text_content">
                                    대댓글 1 대댓글 1 대댓글 1 대댓글 1 대댓글 1 대댓글 1 대댓글 1 대댓글 1 대댓글 1
                                    대댓글 1 대댓글 1 대댓글 1 대댓글 1 대댓글 1
                                </div>
                            </div>
                        </div>
                        <div className="each_re_reply_text_content">
