    ...
    return (
        <div className="flex">
            ...
            <div className="detail_post_wrap" >
                ...
                <div className="text_contents_in_detail">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quam, ea similique! Iusto dignissimos consectetur quia totam. Doloribus ratione consectetur magni distinctio in, officiis nesciunt, sunt recusandae cumque maxime deleniti optio.</div>
                ...
                <div className="write_reply_box">
                    <div className="each_reply_box">
                        <div className="flex_for_profile">
                            ...
                            <div>
                                <img 
                                    src="/test_imgs/png/more.png" 
                                    style={{width:'20px', height:'60px', objectFit:'contain', marginRight:'10px'}} 
                                    data-bs-toggle="modal" 
                    ...
                    <div className="each_reply_box">
                        ...
                        <div className="reply_text_content">
                            댓글 2 댓글 2 댓글 2 댓글 2 댓글 2 댓글 2 댓글 2 댓글 2 댓글 2 댓글 2 댓글 2 댓글 2 댓글 2 댓글 2 댓글 2 
                        </div>
                        <div className="each_re_reply_text_content">
                            ...
                            <div className="re_reply_content_box">
                                ...
                                <div className="reply_text_content">
                                    대댓글 1 대댓글 1 대댓글 1 대댓글 1 대댓글 1 대댓글 1 대댓글 1 대댓글 1 대댓글 1 대댓글 1 대댓글 1 대댓글 1 대댓글 1 대댓글 1 
                                </div>
                            </div>
                        </div>
                        <div className="each_re_reply_text_content">
                    ...
                    <div className="division_box_for_write_reply">
                        <div>
                            <textarea className="upload_reply" name="text" placeholder="댓글 달기..." rows={'1'}></textarea>
                        </div>
            ...
            {/* 모달 START */}
            <div class="modal fade" id="modal_for_change_reply" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-lg-text modal-dialog-centered modal-dialog-scrollable">
                    <div class="modal-content">
                        <div class="modal-body mx-auto" style={{width:'450px', textAlign:'center', fontWeight:'bold'}}>
                            <a href='/detail'>
                                <div>대댓글 작성</div>
                            </a>
                            <hr />
                            ...
                            <hr />
                            <div data-bs-toggle="modal" data-bs-target="#modal_for_post_declaration" style={{color:'red'}}>댓글 신고</div>
                            <hr />
                            <div data-bs-dismiss="modal" aria-label="Close">취소</div>
                        </div>
                    </div>
                </div>
            </div>
