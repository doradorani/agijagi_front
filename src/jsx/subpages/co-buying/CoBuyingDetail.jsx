...
const CoBuyingDetail = ({ setSelectedSideMenu }) => {
        ...
        if (selectedOption === '' || selectedOption === null) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    validateFunding('put', '/coBuy/fundingProduct/' + detailProductNo + '/' + selectedOption)
    ...
    const cancelFunding = async () => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                console.log('test');
                validateFunding('put', '/coBuy/cancelFundingProduct/' + detailProductNo)
                    .then((fundingResponse) => {
                        if (fundingResponse.success) {
                            Swal.fire('펀딩이 취소되었습니다.', '아쉬워요...', 'success');
