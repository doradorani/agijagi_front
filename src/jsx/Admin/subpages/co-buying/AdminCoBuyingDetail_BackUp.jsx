    ...
    useEffect(() => {
        const listProduct = async () => {
            try {
                ...
                const detailCobuy = validateDetailProductResponse.data.coBuyDetailProduct;

                setDetailCobuy({
                    adminCobuyNo: detailCobuy.no,
                    adminCobuyId: detailCobuy.id,
                    adminCobuyName: detailCobuy.name,
                    adminCobuyContent: detailCobuy.content,
                    adminCobuyPrice: detailCobuy.price,
                    adminCobuyImg: detailCobuy.img,
                    adminCobuyStart: detailCobuy.start_date,
                    adminCobuyEnd: detailCobuy.end_date,
                    adminCobuyMin: detailCobuy.min_num,
                    adminCobuyState: detailCobuy.state,
                    adminCobuyHit: detailCobuy.hit,
                    adminCobuyOption1: detailCobuy.option1,
                    adminCobuyOption2: detailCobuy.option2,
                    adminCobuyOption3: detailCobuy.option3,
                    adminCobuyOption4: detailCobuy.option4,
                    adminCobuyOption5: detailCobuy.option5,
                    adminCobuyReg: detailCobuy.reg_date,
                    adminCobuyMod: detailCobuy.mod_date,
                });
